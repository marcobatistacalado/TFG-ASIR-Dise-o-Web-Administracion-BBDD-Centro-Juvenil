...
<body>
    ...
    <main>
        <div class="c_cont-portada" id="a_musical">
            <h1>Musical: Shrek</h1>
        </div>
        <article>
            ...
            <div class="c_informacion">
                <div class="c_texto c_texto_secciones">
                    <p>
                    ¡Bienvenidos al espectáculo del musical Shrek presentado por el Centro Juvenil La Balsa! Este evento será realizado en mayo de 2023 y cuenta con un elenco compuesto por jóvenes talentosos de entre 14 y 18 años de edad.
                    <br><br>Durante esta producción, te invitamos a acompañar a Shrek, un ogro solitario que vive en un pantano, en su aventura para salvar a la princesa Fiona y regresarla a su prometido, Lord Farquaad. Acompañado por su fiel amigo Burro, Shrek se enfrentará a numerosos desafíos y conocerá a personajes inolvidables como el Gato con Botas y la Dragóna.
                    <br><br>La música, las coreografías y las actuaciones en vivo de nuestros jóvenes actores te sorprenderán y te llevarán a un mundo de fantasía y diversión. Este musical es una oportunidad única para ver el talento y la creatividad de nuestros jóvenes en acción.
                    <br><br>Te invitamos a ser parte de esta experiencia y a disfrutar de una noche llena de risas, emociones y buena música. ¡No te pierdas el musical Shrek del Centro Juvenil La Balsa en mayo de 2023!
        ...
        <div class="c_cont-portada">
            ...
            <div class="cards">
				<label class="card" for="item-1" id="song-1">
					<img src="../img/musical6.JPG" alt="song">
				</label>
				<label class="card" for="item-2" id="song-2">
					<img src="../img/musical4.jpg" alt="song">
				</label>
				<label class="card" for="item-3" id="song-3">
					<img src="../img/musical5.jpg" alt="song">
				</label>
			</div>
